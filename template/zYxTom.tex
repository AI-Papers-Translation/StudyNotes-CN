% Changelog
% 2020-05-4
%   已经与 pandoc 2.9.2 的默认模板比对过
%   修正了页头和页脚的显示
%   删除了文档中多余的代码
%   修正了部分与字体相关的设置
%%
% This is the zYx.Tom pandoc LaTeX template.
%
% For usage information and examples visit the official GitHub page:
% https://github.com/zhuyuanxiang/StudyNotes-CN/tree/master/template
%%
...
$endif$
breaklinks=true,
pdfcreator={LaTeX via pandoc with the zYx.Tom template}}
...
$endif$
$if(graphics)$
  % \usepackage{graphicx,grffile} 去掉grffile支持jpg文件
  \usepackage{graphicx}
  \makeatletter
...
$else$
  ...
  $else$
    ...
    \pagestyle{fancy}
    \fancyhf{} % 清空默认内容
    % 奇偶页功能必须定义：documentclass[twoside]
    \fancyhead[L]{$if(header-left)$$header-left$$else${\nouppercase{\leftmark}}$endif$}
    \fancyhead[OC]{$if(header-center)$$header-center$$else$$endif$}
    \fancyhead[EC]{$if(header-center)$$header-center$$else$$endif$}
    \fancyhead[R]{$if(header-right)$$header-right$$else${\nouppercase{\rightmark}}$endif$}
    \fancyfoot[L]{$if(footer-left)$$footer-left$$else$QQ: 526614962$endif$}
    \fancyfoot[CO]{$if(footer-center)$$footer-center$$else${\href{https://zhuyuanxiang.github.io}{zYx.Tom's 主页}}$endif$}
    \fancyfoot[CE]{$if(footer-center)$$footer-center$$else${\href{https://github.com/zhuyuanxiang/StudyNotes-CN}{zYx.Tom's 项目}}$endif$}
